      ...
      (n.addListener = n.on),
        ...
        (n.emit = function (t, e) {
          if (
            ...
            try {
              for (
                var r, a = this._eventEmitterCallbacks[t][Symbol.iterator]();
                !(i = (r = a.next()).done);
                i = !0
              ) {
                var o = r.value;
                ...
                for (t = 0; t < e.length; t++) {
                  ...
                  (i = (i = i.replace(".", "")).replace("-", "")),
                    ...
                    e[t].dataset.llpDuration ||
                      (e[t].dataset.llpDuration = 1e3),
                    e[t].dataset.llpDuration || (e[t].dataset.llpDelay = 0);
                }
                return (
                  this.config.log &&
                    console.log(
                      "This lazy line is uncomposed! Visit http://lazylinepainter.info to compose your masterpiece!"
                    ),
                  e
                );
              },
              ...
              value: function () {
                for (var t = 0; t < this.__paths.length; t++) {
                  var e = this.__paths[t],
                    i = void 0;
                  (e.progress = 0),
                    (i = this.config.reverse
                      ? this.config.drawSequential
                        ? 0
                        : this.config.totalDuration - (e.delay + e.duration)
                      : this.config.drawSequential
                      ? 0
                      : this.config.delay + e.delay),
                    (e.startTime = i),
            ...
            },
            {
              ...
              value: function (t) {
                (t.strokeColor =
                  ...
                  (t.strokeOpacity =
                    t.el.dataset.llpStrokeOpacity || this.config.strokeOpacity),
                  t.strokeOpacity &&
                    (t.el.style.strokeOpacity = t.strokeOpacity),
                  (t.strokeWidth =
                    t.el.dataset.llpStrokeWidth || this.config.strokeWidth),
                  t.strokeWidth && (t.el.style.strokeWidth = t.strokeWidth),
                  (t.strokeCap =
                    t.el.dataset.llpStrokeCap || this.config.strokeCap),
              ...
              value: function () {
                for (var t = 0; t < this.__paths.length; t++) {
                  ...
                  (e.index = t),
                    ...
                    (e.positions = this._getPathPoints(e.el, e.length)),
                    (e.el.style.strokeDasharray = this._getStrokeDashArray(
                      e,
                      e.length
                    )),
                    (e.el.style.strokeDashoffset = e.length),
                ...
                if (this.config) {
                  ...
                  (this.config.elapsedTime = e - this.config.startTime),
                    ...
                    this.config.linearProgress <= 1
                      ...
                      ? (this.config.repeat--, this.paint())
                      : -1 === this.config.repeat
                      ? this.paint()
                      : this.emit("complete");
                }
              },
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  ...
                  this.config.progress <= t.startProgress + t.durationProgress
                    ? (e =
                        (this.config.progress - t.startProgress) /
                        t.durationProgress)
                    : this.config.progress >=
                      t.startProgress + t.durationProgress
                    ? (e = 1)
              ...
              value: function (t) {
                1 === t.progress
                  ? t.onStrokeCompleteDone ||
                    ...
                    this.emit("complete:all", t))
                  : t.progress > 1e-5 &&
                    (t.onStrokeStartDone ||
                      (this.emit("start:" + t.id, t),
